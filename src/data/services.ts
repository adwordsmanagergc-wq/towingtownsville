...
export const services: ServicePage[] = [
  ...
  },
  {
    ...
    intro:
      "A flat battery is the single most common Townsville roadside callout, and most are fixed in a few minutes — either with a clean jump start or a quick assessment that the battery is finished and the car needs a tow to a battery shop. Townsville's heat is hard on lead-acid batteries, and modern stop-start vehicles draw current even when parked. The recommended operators here can attend a flat battery anywhere in the metro, jump-start safely (including newer vehicles where booster terminals are not at the battery itself) and tow on the same call if the battery will not take a charge. Mention on the call whether the dash electronics still work — that helps the operator bring the right kit.",
    included: [
  ...
  },
  {
    ...
    intro:
      "Running out of fuel happens — between Townsville's longer suburb-to-suburb runs, the Ring Road and the southern stretch of the Bruce Highway, it can be a long way between service stations. The recommended operators here can deliver enough fuel to get you to the nearest pump (typically 5–10 litres of petrol or diesel), and they will tow you instead if the vehicle has other issues. Tell them on the call whether your vehicle takes petrol or diesel and roughly how much you need. If you have put the wrong fuel in by mistake, do not start the engine — call for a tow rather than a delivery, because a misfuel needs a tank drain at a workshop.",
    included: [
