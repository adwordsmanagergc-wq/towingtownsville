  ...
  return (
    <section className="relative overflow-hidden bg-navy-800 text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div className="grid gap-10 md:gap-12 md:grid-cols-[1.15fr_1fr] items-center">
          <div>
            ...
            <p className="mt-5 text-lg md:text-xl text-slate-100/90 max-w-2xl leading-relaxed">
              We compare every type of tow service in Townsville — from a flat tyre on the Ring
              Road to a multi-vehicle prang in Aitkenvale — and recommend the two local
              operators we trust most for fast, properly insured, damage-free recoveries.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-xs md:max-w-md">
            <div
              aria-hidden
              className="absolute inset-0 -m-8 rounded-full bg-[radial-gradient(circle,_rgba(242,107,31,0.25),_transparent_70%)] blur-2xl"
            />
            <Image
              src="/hero/towing-townsville.png"
              alt="Towing Townsville — Reliable Recovery Service badge"
              width={928}
              height={1152}
              priority
